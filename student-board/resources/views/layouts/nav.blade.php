<nav x-data="{ open: false }" class="bg-white border-b border-gray-100  sticky top-0 z-50">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('timetables.index')" :active="request()->routeIs('timetables.index')">
                        {{ __('Timetables') }}
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @guest
                    <a href="{{ route('login') }}" class="text-sm text-gray-600 underline">Login</a>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('timetables.index')" :active="request()->routeIs('timetables.index')">
                {{ __('Timetables') }}
            </x-responsive-nav-link>
